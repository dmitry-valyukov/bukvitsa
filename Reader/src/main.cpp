...
wxl::Teardown wxl_launched() {
    ...
    // Проба системного задника. Полоса, которую быстрый ресайз обнажает,
    // сейчас белая — её красит каркас окна, не мы. Красный вместо белого при
    // растяжке за угол докажет, что задник живёт на стороне системного
    // композитора и успевает за рамкой; дальше сюда встанет бумага темы или
    // сама картинка подложки.
    wxl::window_backdrop_color(window, wxl::ARGB{255, 0, 0});
