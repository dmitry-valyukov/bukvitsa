...
// смену книги.
//
// Перенесено из Abajour почти как есть: Abajour был первой версией читалки и
// уходит, когда Reader его догонит, а держать этот класс в общем модуле не за
// что — он ровно про то, что нужно приложению, и ни одному другому.
